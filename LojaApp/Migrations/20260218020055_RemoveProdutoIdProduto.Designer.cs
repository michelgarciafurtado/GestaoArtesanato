...
namespace LojaApp.Migrations
{
    ...
    [Migration("20260218020055_RemoveProdutoIdProduto")]
    partial class RemoveProdutoIdProduto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LojaApp.Models.Pedidos.ItemPedido", b =>
                {
                    b.Property<string>("IdItemPedido")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
            ...
            modelBuilder.Entity("LojaApp.Models.Pedidos.Pedido", b =>
                {
                    b.Property<string>("IdPedido")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
            ...
            modelBuilder.Entity("LojaApp.Models.Users.Cliente", b =>
                {
                    b.Property<string>("IdCliente")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
            ...
            modelBuilder.Entity("LojaApp.Models.Users.Endereco", b =>
                {
            ...
            modelBuilder.Entity("LojaApp.Models.Pedidos.ItemPedido", b =>
                {
                    b.HasOne("LojaApp.Models.Pedidos.Pedido", "Pedido")
            ...
            modelBuilder.Entity("LojaApp.Models.Pedidos.Pedido", b =>
                {
                    b.HasOne("LojaApp.Models.Users.Cliente", "Cliente")
                        .WithMany("Pedidos")
            ...
            modelBuilder.Entity("LojaApp.Models.Users.Cliente", b =>
                {
                    b.HasOne("LojaApp.Models.Users.ApplicationUser", "User")
                        .WithOne("Cliente")
                        .HasForeignKey("LojaApp.Models.Users.Cliente", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LojaApp.Models.Users.Endereco", b =>
                {
                    b.HasOne("LojaApp.Models.Users.Cliente", null)
                        .WithMany("Enderecos")
